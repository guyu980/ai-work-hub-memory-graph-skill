...
5. 普通外部查证留在本流程；只有用户明确要求深度研究或正式系统报告时调用 Deep Research，具体项目判断交由 Diligence。
6. 来源观点不默认转为核验任务；核心分析按价值展开，后续问题仅在有用时提出。
...
<!-- 访谈按问题与回答整理，其他材料按原文逻辑整理。 -->

## 重要来源口径与不确定性

<!-- 区分来源观点和分析假设；只记录影响理解的矛盾或转写问题，不逐条核验。 -->

## 与既有认知的连接和变化

<!-- 相关项目、赛道、技术或估值；强化、修正还是反驳，类比边界在哪里。 -->

## 后续问题与知识写回

<!-- 仅列有价值的下一步及实际更新的对象；没有则简写，不生成任务或卡片凑数。 -->
"""
